...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[R]{KBSS-stadgar-2025}
\fancyhead[L]{Senast uppdaterad: 2025-09-29}
%\fancyhead[C]{Organisationsnummer: 802427-8247}
\fancyfoot[L]{Konglig Bergs Spectacle Sellskap\\Org.Nr.: 802427-8247}
\fancyfoot[C]{}
\fancyfoot[R]{\\\thepage}
...
\underparagraf{Sellskapet skall under varje verksamhetsår verka för att producera ett \mbox{spectacle.}}
\vspace{1.5em}
...
\underparagraf{Årsmötet är beslutsmässigt med $\sfrac{1}{4}$ av medlemmarna närvarande.}
...
\underparagraf{Vid ordinarie årsmöte sker val av: verkmestare, präntmestare, räntmestare, fyrmestare, regissör, musikchef, dekorchef, sminkchef, ljud- och ljuschef samt två revisorer.}
\underparagraf{Omständigheterna kring valen ombesörjes av lilla rådet. Minst en revisor delar vid rösträkningen.}
\underparagraf{Vid sekundärt årsmöte sker val av manuschef.}
\vspace{1.5em}
